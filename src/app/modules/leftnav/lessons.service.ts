...
const conteudo1 =
  '<p>O batismo é uma ordenança de Jesus a sua lgreja Mt 28.19,20. Jesus incumbiu seus discipulos de fazer discipulos e batizá-los. A Igreja de Cristo é composta por discipulos e, portanto, é a continuadora da obra dos primeiros discipulos.</p>' +
  ...
  '<li>é decisăo para mudança de Reino. E mudança de vida, de valores, de perspectivas.</li></ul>' +
  ...
  '<p><strong> 6.0 batismo purifica pecados?</strong> Não. O que purifica pecados éo sangue de Jesus-1 João 1.7. Se cada vez que fizéssemos algo errado fosse necesario ser batizado, teríamos que passar pelo batismo muitas vezes. O crente não vive na pratica do pecado, mas atingirá a perfeição somente na vinda de nosso Senhor Jesus.</p>' +
  '<p><strong>7. Qual é o valor do batismo?</strong></p>' +
  '<li>- Ele é a marca do novo nascimento João 3.5;</li>' +
  '<li>- é a confissao pública de que somos discipulos de Jesus- Mateus 10.04</li>' +
  '<li>- Simboliza 0 sepultamento do velho homem- Colossenses 2.12</li></ul>' +
  '<p><strong>8. Por que não praticamos o batismo infantil:</strong></p>' +
  '<p>8.1.porque não temos base bíblica para o batismo de crianças;</p>' +
  '<p>8.2.para ser salvo é preciso confessar verbalmente o senhorio de Jesus- Rm 10.9;</p>' +
  '<p>8.3.quando nenen, apresentamos a Jesus; assim que aprende a falar, levamos a criança a receber Jesus como Salvador, e quando já sabe discernir entre o certo e o errado, então, pode cumprir com a ordem de Jesus.</p>';
//__________________________________________________________________________________________________________________________________
const content2 =
  '<p>A segunda ordenança que Jesus deixou para a lgreja foi a Ceia. Esta ordenança foi instituida pelo Senhor horas antes de sua morte, como um memorial da nova aliança, o novo pacto que Ele estava fazendo com os homens; aliança esta que seria selada com seu próprio sangue Mateus 26.26-28.</p>' +
...
//__________________________________________________________________________________________________________________________________
const content3 =
  '<p>Queremos dar nesta lição respostas a algumas perguntas que são muito frequentes. Entre elas: Qual foi a primeira lgreja? Qual é a verdadeira lgreja?  Por que eu tenho que participar da Igreja? Por que não posso servir a Deus em casa?</p>' +
...
export class LessonsService {
  options = new SelectionModel(false, [0]);
  ...
  lessonsList$ = signal<Lesson[]>([
    {
      ...
      questions: [
        ...
        },
        {
          index: 2,
          question:
            'A forma bíblica do batismo, conforme o sentido etimológico da palavra é por: Im',
        },
        {
          index: 3,
          question:
            'A fórmula ensinada por Jesus em Mateus 28.19 é: "Em nome do _______, do ________ e do ___________"',
        },
        {
          index: 4,
          question:
            'Quais as condições para que uma pessoa seja batizada? Marcos 16.16 _____ Atos 2.38 _____ 1 João 1.9 _____ João 3.3 _____',
        },
        {
          index: 5,
        ...
        },
        {
          index: 7,
          question:
            'Qual o valor do batismo? João 3:5 ____- Mateus 10:32 ____ Colossenses 2:12',
        },
        {
          index: 8,
          question:
            'Por que não praticamos o batismo infantil? (responda con suas palavras)',
        },
      ],
      content: conteudo1,
    },
      ...
      questions: [
        {
          index: 1,
          question:
            'O que é a Ceia do Senhor segundo está em 1 Coríntios 11.23-32? - É com _______________ - É inst_______________ -É insp________________ -É anun _______________',
        },
        {
          index: 2,
          question:
            'Quem pode participar da Ceia do Senhor? ______________________________________________________',
        },
        {
          index: 3,
          question:
            'Quais as condições para o crente participar da Ceia do Senhor? -Com a vida em_______________ -Examinado-se a ____________________ -Discernindo o ______________',
        },
        {
          index: 4,
          question:
            'O que acontece quando se participa da Ceia do Senhor indignamente? (Leia 1 Corintios 11.30)_______________________________________________________________',
        },
        {
          index: 5,
          question:
            'Qual a forma que nós batistas usamos para celebrar a Ceia do Senhor? ________________________________________________________',
        },
        {
          index: 6,
          question:
            'Explique com suas palavras por que é importante o crente participar da Ceia do Senhor?____________________________________',
        },
      ],
      content: content2,
    },
